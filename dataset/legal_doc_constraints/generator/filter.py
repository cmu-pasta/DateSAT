...
TAX_ANCHORS = [
    ...
    r"\bcalendar\s+quarter\b",
    r"\bcalendar\s+quarter(s)?\b",
    r"\bfiscal\s+year\b",
    r"\bplan\s+year\b",
    r"\bclose\s+of\s+the\s+taxable\s+year\b",
    r"\bfor\s+each\s+taxable\s+year\b",
    r"\bfor\s+any\s+taxable\s+year\b",
    r"\bfor\s+each\s+calendar\s+quarter\b",
    r"\bfor\s+any\s+calendar\s+quarter\b",
    r"\bfor\s+each\s+taxable\s+period\b",
    r"\bdate\s+of\s+filing\b",
    r"\bdate\s+of\s+payment\b",
    r"\bdue\s+date\b",
    r"\bassessment\b",
    r"\bdeficiency\b",
    r"\bclaim\s+for\s+refund\b",
    r"\breturn\s+filing\b",
    r"\bfiling\s+date\b",
    r"\bstatute\s+of\s+limitations\b",
]
...
EFFECTIVE_CUES = [
    ...
    r"\bfor\s+taxable\s+years\s+beginning\s+after\b",
    r"\bfor\s+taxable\s+years\s+ending\s+before\b",
