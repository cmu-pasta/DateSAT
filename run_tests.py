...
def main():
    parser = argparse.ArgumentParser(description="Run DATE-SMT unit tests")
    parser.add_argument(
        "--category",
        choices=[
            "core",
    ...
    if args.category == "all":
        ...
        cmd.append("tests/core_data_structures/")
    elif args.category == "validation":
        cmd.append("tests/date_validation/")
    elif args.category == "symbolic":
        cmd.append("tests/symbolic_variables/")
    elif args.category == "solver":
        cmd.append("tests/solver_tests/")
    elif args.category == "api":
        cmd.append("tests/api_integration/")
    elif args.category == "comparison":
        cmd.append("tests/semantic_comparison/")
    elif args.category == "algorithm":
        cmd.append("tests/algorithm_specific/")
    elif args.category == "error":
        cmd.append("tests/error_handling/")
    elif args.category == "integration":
        cmd.append("tests/integration_tests/")
    elif args.category == "performance":
        cmd.append("tests/performance_tests/")
    ...
    # Run the tests
    success = run_command(cmd, f"Unit tests for {args.category} category")
